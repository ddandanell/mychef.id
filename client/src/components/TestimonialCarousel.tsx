...
const TESTIMONIALS_ROW2: Testimonial[] = [
  ...
  },
  {
    ...
    guestCount: '14',
    discoverySource: 'Friend referral',
    review: `My cousin used myCHEF for her wedding and insisted I book them for my bachelorette party in Bali. I had fourteen girlfriends flying in from different countries for a long weekend and I wanted the food experiences to be memorable and fun, not stressful. This was my last hurrah before getting married and I wanted every moment to be perfect. We planned two events with myCHEF - a bottomless brunch on Saturday and a dinner party Sunday night. The team coordinated both seamlessly. For brunch, they created a gorgeous spread with avocado toast, acai bowls, pancakes, fresh tropical fruit, and a build-your-own mimosa bar with fresh juices. The chef and two helpers set up a beautiful table with flowers and served everything family-style so we could relax and enjoy. Everyone loved the food and the mimosas were flowing. For dinner, they completely transformed our villa dining area with candles, string lights, and a long beautiful table setting. The chef designed a fun sharing-style menu with Asian fusion dishes - think crispy duck pancakes, Thai beef salad, pad thai, green curry, and mango sticky rice for dessert. They brought a sound system and we had our bachelorette playlist going all night. The food was incredible and the energy was so fun. The staff kept everything moving smoothly while staying out of the way so we could just be together. Both days, cleanup was handled completely by the team and we never had to think about it. Multiple friends said these meals were highlights of the entire trip. My maid of honor told me booking myCHEF was the best decision I made for the bachelorette. The whole experience let us focus on celebrating together instead of stressing about logistics. Could not have asked for a better experience.`,
  },
  {
    name: 'Mia R.',
    location: 'Sanur',
