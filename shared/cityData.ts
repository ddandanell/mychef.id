...
export const CITY_DATA: Record<string, CityData> = {
  ...
  canggu: {
    name: 'Canggu',
    slug: 'canggu',
    seoTitle: 'Private Chef in Canggu, Bali — Echo Beach, Berawa & Pererenan | myCHEF',
    seoDescription: 'Private chef for Canggu villas: Echo Beach, Berawa, Batu Bolong & Pererenan. Mediterranean, plant-based, Asian fusion. Same-day available. WhatsApp.',
  ...
  uluwatu: {
    name: 'Uluwatu',
    slug: 'uluwatu',
    seoTitle: 'Private Chef Uluwatu, Bali — Sunset Cliff Dinners & Proposal Setups | myCHEF',
    seoDescription: 'Private chef for Uluwatu cliff villas: sunset-timed dinners, romantic proposals, surf-group feasts. Bulgari, Karma Kandara, Alila covered. WhatsApp.',
